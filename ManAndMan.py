    ...
    while True:
        ...
        if winner:
            ...
            if winner == BLACK_CHESSMAN:
                print_text(screen, font1, RIGHT_INFO_POS_X, Start_X + 5, "Wins!", BLUE_COLOR)
            else:
                print_text(screen, font1, RIGHT_INFO_POS_X, Start_X + Stone_Radius2 * 3 + 5, "Wins!", BLUE_COLOR)            
        
        if cur_runner == BLACK_CHESSMAN:
            print_text(screen, font1, RIGHT_INFO_POS_X, Start_X + 5, "" if winner else "Thinking.....", BLUE_COLOR)
        if cur_runner == WHITE_CHESSMAN:
            print_text(screen, font1, RIGHT_INFO_POS_X, Start_X + Stone_Radius2 * 3 + 5, "" if winner else "Thinking.....", BLUE_COLOR)
